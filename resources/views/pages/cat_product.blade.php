					...
					<div class="shop_sidebar">
						<div class="sidebar_section">
							...
							<ul class="sidebar_categories">
								...
								<li><a href="{{url('cat/products/'.$cat->id)}}">{{$cat->category_name}} </a></li>
								@endforeach
							</ul>
						</div>
						...
						<div class="sidebar_section">
							...
							<ul class="brands_list">
								...
								@php
									$brands=DB::table('brands')->where('id', $bra->brand_id)->first();
								@endphp
				...
				<div class="col-lg-9">
					...
					<div class="shop_content">
						...
						<div class="" style="display: flex; flex-direction: row;">
							...
							<!-- Product Item -->
							<div class="product_item is_new mr-3">
								<div class="product_border"></div>
								<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{asset($row->image_one)}}" style="height: 140px; width:130px"></div>
                                ...
                                <li class="product_mark product_new" style="background: red;">@php
