...
<div class="contact_form">
    <div class="container"> 
      <div class="row">
        <div class="col-8 card">
          <table class="table table-response">
            ...
            @endif  
                ...
                <td scope="col">
                    @if ($row->return_order==0)
                    <a href="{{url('return/order/'.$row->id)}} " id="return" class="btn btn-sm btn-danger"> Return</a>
                    @elseif($row->return_order==1)
                    <span class="badge badge-info">requested</span>
                    @elseif($row->return_order==2)
                    <span class="badge badge-success">success</span>
        ...
        <div class="col-4">
          <div class="card">
            <img src="{{ asset('public/frontend/images/user_profile.jpg') }}" class="card-img-top" style="height: 90px; width: 90px; margin-left: 34%;">
            <div class="card-body">
