    ...
    @csrf
        <div class="form-layout">
          <div class="row mg-b-25">
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <input class="form-control" type="text" name="name" value="" required placeholder="Enter  name">
              </div>
            </div><!-- col-4 -->
            <div class="col-lg-6">
              <div class="form-group">
                <label class="form-control-label"> Phone: <span class="tx-danger">*</span></label>
                <input class="form-control" type="text" name="phone" value="" required placeholder="Enter Phone ">
              </div>
            </div><!-- col-4 -->
            <div class="col-lg-6">
              <div class="form-group">
                <label class="form-control-label"> Email: <span class="tx-danger">*</span></label>
                <input class="form-control" type="text" name="email" value="" required placeholder="Enter email ">
              </div>
            </div><!-- col-4 -->
            <div class="col-lg-6">
              <div class="form-group">
          ...
          <div class="form-layout-footer">
            <button type="submit" class="btn btn-info mg-r-5">Add User</button>
