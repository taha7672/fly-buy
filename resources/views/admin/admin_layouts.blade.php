...
<link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/css/toastr.css">
  ...
  <body>
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href=""><i class="icon ion-android-star-outline"></i>Fly Buy</a></div>
    <div class="sl-sideleft">
      ...
      @if (Auth::user()->category==1)
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{route('create.product')}} " class="nav-link">Create Product</a></li>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{route('order.neworder')}} " class="nav-link">New Order</a></li>
          <li class="nav-item"><a href="{{route('pending.payment')}} " class="nav-link">Accepted Payment</a></li>
          <li class="nav-item"><a href="{{route('accepted.payment')}} " class="nav-link">Pending Payment</a></li>
          <li class="nav-item"><a href="{{route('progress.payment')}} " class="nav-link">Progress Delivery</a></li>
        ...
        <ul class="sl-menu-sub nav flex-column">
          ...
          <li class="nav-item"><a href=" {{route('month.order')}}" class="nav-link">Month Order</a></li>
          <li class="nav-item"><a href=" {{route('deliverd.order')}}" class="nav-link">Delivered Orders</a></li>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{route('new.user')}}" class="nav-link">Crete User</a></li>
          <li class="nav-item"><a href="{{route('user.role')}}" class="nav-link">All User</a></li>
  
        </ul>
        @else
          
        @endif
        @if (Auth::user()->oreturn==1)
        ...
        <ul class="sl-menu-sub nav flex-column">
          {{-- <li class="nav-item"><a href="{{route('newslater')}}" class="nav-link">New Message</a></li> --}}
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{route('newslater')}}" class="nav-link">New Comments</a></li>
          <li class="nav-item"><a href="{{route('newslater')}}" class="nav-link">All Comments</a></li>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{route('stock')}}" class="nav-link">Stock</a></li>
