...
<meta name="description" content="Fly Buy shop project">
			...
			<div class="container">
				<div class="row">
					<div class="col d-flex flex-row">
						<div class="top_bar_contact_item"><div class="top_bar_icon"><img src="{{asset('public/frontend/images/phone.png')}}" alt=""></div>+93 309 7672118</div>
						<div class="top_bar_contact_item"><div class="top_bar_icon"><img src="{{asset('public/frontend/images/mail.png')}}" alt=""></div><a href="mailto:tahaverified@gmail.com">tahaverified@gmail.com</a></div>
						<div class="top_bar_content ml-auto">
							<div class="top_bar_menu">
								<ul class="standard_dropdown top_bar_dropdown">
									...
									$language =Session()->get('lang');
										...
										<a href="{{route('lang.urdu')}} ">Urdu<i class="fas fa-chevron-down"></i></a>
							...
							<div><a href="{{route('login')}} ">Register/Sign in</a></div>
								...
								<ul class="standard_dropdown top_bar_dropdown">
									<li>
										<div class="user_icon"><img src="{{asset('public/frontend/images/user.svg')}}" alt=""></div><li>
                                  <a href="{{asset('home')}} ">Profile<i class="fas fa-chevron-down"></i></a>
											<ul>
				...
				<div class="row">
					...
					<div class="col-lg-2 col-sm-3 col-3 order-1">
						<div class="logo_container">
							<div class="logo"><a href="{{asset('')}} ">Fly Buy</a></div>
						</div>
					</div>
										...
										<div class="custom_dropdown">
											<div class="custom_dropdown_list">
												...
												<ul class="custom_list clc">
													...
													<li><a class="clc" href="{{url('cat/products/'.$cat->id)}}">{{$cat->category_name}} </a></li>
													@endforeach
												</ul>
											</div>
										</div>
			...
			<div class="row">
				...
				<div class="col-lg-3 footer_col">
					<div class="footer_column footer_contact">
						...
						<div class="footer_phone">+92 309 7672118</div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Taha</a>
		...
		$(document).on("click", "#return", function(e){
			...
			var link = $(this).attr("href");
			   swal({
				 ...
				 text: "Once Returned, This will be returned!",
				 icon: "warning",
				 buttons: true,
				 dangerMode: true,
			   })
