                ...
                <div class="main_nav_content d-flex flex-row">
                    ...
                    <div class="cat_menu_container">
                        ...
                        <ul class="cat_menu">
                            ...
                            <li class="hassubs">
                                <a href="{{url('cat/products/'.$cat->id)}}">{{$cat->category_name}}<i class="fas fa-chevron-right"></i></a>
                                <ul>
                                    @php
                                    ...
                                    <li class="hassubs">
                                        <a href="{{url('products/'.$subcat->id)}} ">{{$subcat->subcategory_name}} </a>
                                        <ul>      
                                        </ul>
                                    </li>
                                    @endforeach
                    ...
                    <div class="main_nav_menu ml-auto">
                        <ul class="standard_dropdown main_nav_dropdown">
                            <li><a href="{{asset('')}}">Home<i class="fas fa-chevron-down"></i></a></li>
                            <li class="hassubs">
                            ...
                            <li><a href="{{route('admin.login')}}">Admin Side<i class="fas fa-chevron-down"></i></a></li>
                        </ul>
                    </div>
